...
% temp=1;
% for i=1:L
%     if(real(detect(i))==-5 && imag(detect(i))==1)
%       h(temp:temp+4)=[0 1 0 1 0];
%       temp=temp+k;
%     elseif(real(detect(i))==-3 && imag(detect(i))==1)
%         h(temp:temp+4)=[1 1 0 1 0];
%         temp=temp+k;
%     elseif(real(detect(i))==-1 && imag(detect(i))==1)
%         h(temp:temp+4)=[0 0 1 1 0];
%         temp=temp+k;
%     elseif(real(detect(i))==1 && imag(detect(i))==1)
%         h(temp:temp+4)=[1 0 1 1 0];
%         temp=temp+k;
%         
%         elseif(real(detect(i))==3 && imag(detect(i))==1)
%         h(temp:temp+4)=[0 1 1 1 0];
%         temp=temp+k;
%     elseif(real(detect(i))==5 && imag(detect(i))==1)
%         h(temp:temp+4)=[1 1 1 1 0];
%         temp=temp+k;
% 
%   
%     elseif(real(detect(i))==-5 && imag(detect(i))==3)
%         h(temp:temp+4)=[0 0 1 0 0];
%         temp=temp+k;
%   
%     elseif(real(detect(i))==-3 && imag(detect(i))==3)
%         h(temp:temp+4)=[1 0 1 0 0];
%         temp=temp+k;
%   
%     elseif(real(detect(i))==-1 && imag(detect(i))==3)
%         h(temp:temp+4)=[0 1 1 0 0];
%         temp=temp+k;
%   
%     elseif(real(detect(i))==1 && imag(detect(i))==3)
%         h(temp:temp+4)=[1 1 1 0 0];
%         temp=temp+k;
%         
%     elseif(real(detect(i))==3 && imag(detect(i))==3)
%         h(temp:temp+4)=[0 0 0 1 0];
%         temp=temp+k;
%   
%     elseif(real(detect(i))==5 && imag(detect(i))==3)
%         h(temp:temp+4)=[1 0 0 1 0];
%         temp=temp+k;
%   
%     
%  
%     elseif(real(detect(i))==-3 && imag(detect(i))==5)
%         h(temp:temp+4)=[0 0 0 0 0];
%         temp=temp+k;
%  
%     elseif(real(detect(i))==-1 && imag(detect(i))==5)
%         h(temp:temp+4)=[1 0 0 0 0];
%         temp=temp+k;
%  
%     elseif(real(detect(i))==1 && imag(detect(i))==5)
%         h(temp:temp+4)=[0 1 0 0 0];
%         temp=temp+k;
%  
%     elseif(real(detect(i))==3 && imag(detect(i))==5)
%         h(temp:temp+4)=[1 1 0 0 0];
%         temp=temp+k;
%  
%    
%         
%         
%     elseif(real(detect(i))==-5 && imag(detect(i))==-1)
%       h(temp:temp+4)=[0 0 0 0 1];
%       temp=temp+k;
%     elseif(real(detect(i))==-3 && imag(detect(i))==-1)
%         h(temp:temp+4)=[1 0 0 0 1];
%         temp=temp+k;
%     elseif(real(detect(i))==-1 && imag(detect(i))==-1)
%         h(temp:temp+4)=[0 1 0 0 1];
%         temp=temp+k;
%     elseif(real(detect(i))==1 && imag(detect(i))==-1)
%         h(temp:temp+4)=[1 1 0 0 1];
%         temp=temp+k;
%         
%         elseif(real(detect(i))==3 && imag(detect(i))==-1)
%         h(temp:temp+4)=[0 0 1 0  1];
%         temp=temp+k;
%     elseif(real(detect(i))==5 && imag(detect(i))==-1)
%         h(temp:temp+4)=[1 0 1 0 1];
%         temp=temp+k;
% 
%   
%     elseif(real(detect(i))==-5 && imag(detect(i))==-3)
%         h(temp:temp+4)=[0 1 1 0 1];
%         temp=temp+k;
%   
%     elseif(real(detect(i))==-3 && imag(detect(i))==-3)
%         h(temp:temp+4)=[1 1 1 0 1];
%         temp=temp+k;
%   
%     elseif(real(detect(i))==-1 && imag(detect(i))==-3)
%         h(temp:temp+4)=[0 0 0 1 1];
%         temp=temp+k;
%   
%     elseif(real(detect(i))==1 && imag(detect(i))==-3)
%         h(temp:temp+4)=[1 0 0 1 1];
%         temp=temp+k;
%         
%     elseif(real(detect(i))==3 && imag(detect(i))==-3)
%         h(temp:temp+4)=[0 1 0 1 1];
%         temp=temp+k;
%   
%     elseif(real(detect(i))==5 && imag(detect(i))==-3)
%         h(temp:temp+4)=[1 1 0 1 1];
%         temp=temp+k;
%   
%     
%  
%     elseif(real(detect(i))==-3 && imag(detect(i))==-5)
%         h(temp:temp+4)=[0 0 1 1 1];
%         temp=temp+k;
%  
%     elseif(real(detect(i))==-1 && imag(detect(i))==-5)
%         h(temp:temp+4)=[1 0 1 1 1];
%         temp=temp+k;
%  
%     elseif(real(detect(i))==1 && imag(detect(i))==-5)
%         h(temp:temp+4)=[0 1 1 1 1];
%         temp=temp+k;
%  
%     elseif(real(detect(i))==3 && imag(detect(i))==-5)
%         h(temp:temp+4)=[1 1 1 1 1];
%         temp=temp+k;
%   
%         
%     end   
